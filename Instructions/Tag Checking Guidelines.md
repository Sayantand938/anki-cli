...
_Note:_ In the third example above, `MATH::Simple-Interest` was found to be inaccurate for the installment-based payment question and was replaced with `MATH::Installment`.
